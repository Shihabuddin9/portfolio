                ...
                <div className="">
                    ...
                    <div className="md:mt-10 mt-8 flex">
                        ...
                        <div className="ml-5">
                            ...
                            <h2 className="font-bold text-xl">HSC</h2>
                            <p className="text-gray-400 mt-3">Completed HSC education but did not pursue further studies. Later considered continuing education, aspiring for admission into an honors program for further academic advancement.</p>
                        </div>
                    </div>
                </div>
